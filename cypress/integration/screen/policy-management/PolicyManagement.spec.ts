...
describe('Policy Management Integration test', () => {
  ...
  it('should able to type data element', () => {
    cy.get('.ant-modal-body')
      .get('#dataElementName').type('Data Element Test')
      .get('.ant-select').click().type('{downarrow}{enter}')
      .get('#description').type('Data Element Description')
      .get('.ant-btn')
      .contains('Create')
      .click()
  })
  ...
  it('should able to type edit data element', () => {
    cy.get('.ant-modal-body')
      .get('#dataElementName').type('{del}{backspace}{backspace}{backspace}{backspace}edit')
      .get('.ant-select').click().type('{downarrow}{downarrow}{downarrow}{enter}')
      .get('.ant-btn')
      .contains('Update')
      .click()
  })
