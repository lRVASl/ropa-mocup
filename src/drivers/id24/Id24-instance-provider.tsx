...
export const Id24InstanceProvider: React.FC<Props> = ({ children, instance, authenticationHelper }) => {
  return <Id24InstanceContext.Provider value={{ instance, authenticationHelper }}>{children}</Id24InstanceContext.Provider>;
};
